...
export enum CourseActionTypes {
  ...
  CourseLoaded = '[Courses API] Course Loaded Successfully',
  AllCoursesRequested = '[Courses API] All Courses Requested',
  AllCoursesLoaded = '[Courses API] All Courses Successfully Loaded'
